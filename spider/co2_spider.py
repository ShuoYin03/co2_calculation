...
class CO2Spider:
    ...
    async def run(self, date: str, power: str, emission: str, power_type: str, weight: str, departement: str):
        async with async_playwright() as p:
            ...
            await self.select(page, SELECT_ENERGIE_SELECTORS, value=power_type, error_message="Type vehicule select not found")
            ...
            await self.select(page, SELECT_DEPARTEMENT_SELECTORS, value=departement, error_message="Departement select not found")
